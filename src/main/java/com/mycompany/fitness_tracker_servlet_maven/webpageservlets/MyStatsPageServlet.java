 ...
 * @author max
 */
@WebServlet(name = "MyStatsPageServlet", urlPatterns =
{
    "/MyStatsPageServlet"
})
public class MyStatsPageServlet extends HttpServlet
{

    private static final Logger log = LoggerFactory.getLogger(MyStatsPageServlet.class);
