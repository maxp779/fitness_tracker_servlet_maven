 ...
 * @author max
 */
@WebServlet(name = "AJAX_GetUserStats", urlPatterns =
{
    "/AJAX_GetUserStats"
})
public class AJAX_GetUserStats extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        String JSONString = DatabaseAccess.getUserStats(id_user);
        response.setContentType("application/json");
        System.out.println("AJAX_GetUserStats sending JSON object: " + JSONString);
