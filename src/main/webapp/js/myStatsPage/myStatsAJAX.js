...
{
    globalValues["userStats"]["proteingoal"] = document.getElementById("proteingoal").value;
    globalValues["userStats"]["carbohydrategoal"] = document.getElementById("carbohydrategoal").value;
    globalValues["userStats"]["fatgoal"] = document.getElementById("fatgoal").value;
    globalValues["userStats"]["teegoal"] = document.getElementById("teegoal").value;
